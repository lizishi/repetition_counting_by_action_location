...
data_root_test = '/DATA/disk1/lizishi/LLSP/feature/train_rgb.h5'
...
ann_file_test = '/DATA/disk1/lizishi/LLSP/annotation/train_new.csv'
...
# runtime settings
work_dir = '/DATA/disk1/lizishi/react_out/repcount_20230112_with_null_class_iou_decay15'
output_config = dict(out=f'{work_dir}/results_train_part.json')
